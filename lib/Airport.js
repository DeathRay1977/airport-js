...
Airport.prototype.land = function(plane) {
  ...
  if (this.isStormy()) throw "Too stormy to land";
  plane.land();
...
Airport.prototype.weather = function() {
  return this.conditions[Math.round(Math.random() * 2)];
};
...
Airport.prototype.takeOff = function(plane) {
  if (this.isStormy()) throw "Can't take off. Stormy";
  if (!this.isInAirport(plane)) throw "Not in airport";
  plane.takeOff();
